...
enum xm_property_id {
	...
	XM_PROP_PDO2,
	XM_PROP_UVDM_STATE,
#if !defined(CONFIG_VENUS_FOR_BUILD) && !defined(CONFIG_REDWOOD_FOR_BUILD) && !defined(CONFIG_VILI_FOR_BUILD) && !defined(CONFIG_TAOYAO_FOR_BUILD)
	...
	XM_PROP_FG1_TREMQ,
	XM_PROP_FG1_TFULLQ,
#if !defined(CONFIG_REDWOOD_FOR_BUILD) && !defined(CONFIG_TAOYAO_FOR_BUILD)
	...
	XM_PROP_ADSP_RESULT,
#endif
#if (defined(CONFIG_REDWOOD_FOR_BUILD) || defined(CONFIG_VILI_FOR_BUILD) || defined(CONFIG_TAOYAO_FOR_BUILD))
